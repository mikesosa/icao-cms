...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    modules: Schema.Attribute.Component<"module.module", true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPracticeSetPracticeSet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activities: Schema.Attribute.Component<"activity.activity", true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
...
export interface ApiSimulationSimulation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.Component<"simulation-step.simulation-step", true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    videoIntro: Schema.Attribute.Media<"videos">;
  };
}
